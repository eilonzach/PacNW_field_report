...
\begin{tabbing}
\textbf{10:10 am:} 	 \hspace{0.2cm} \= Arrived to the Seattle-Tacoma International Airport, picked up rental cars
...
\subsection{Stop 1 -- Cap Sante Park viewpoint in Anacortes, 3:00 pm}
This stop offers spectacular 360$^{\circ}$ views of Fidalgo Bay, the City of Anacortes, marinas, and the Cascades with snow-capped Mount Baker (Figure~\ref{fig:080314_1}). The viewpoint is located on a hill made up of coarse-grained sedimentary rocks about 60 million years old. Although not a part of the Fidalgo ophiolite per se, these rocks represent near-shore sediments that could be found overlying the oceanic crust. The outcrop allows examination of various sedimentary fabrics and glacial features such as striations and glacially smoothed surfaces. One can also observe glacial till deposits down by the water to the northwest of the viewpoint, which stand out due to their lighter color and noticeably poor consolidation. Another interesting observation that can be made at this stop (as well as en route throughout the day) is the differences in vegetation between various islands scattered in the bay, which is related to bedrock geology. Ultramafic rocks, in particular the low-crustal and mantle sections of the ophioliote complex, weather into soils poor in potassium and other essential nutrients, which cannot support vegetation. Therefore, the ophiolite islands can be recognized from the distance by their relative paucity of vegetation. 

\begin{figure}[h]
\centering
\makebox[\textwidth]{
\subfloat[]{\includegraphics[height=0.55\textwidth]{\fdir/080314_1a.png}}
\subfloat[]{\includegraphics[height=0.55\textwidth]{\fdir/080314_1b.png}}}
...
\centering
\makebox[\textwidth]{
\subfloat[]{\includegraphics[height=0.55\textwidth]{\fdir/080314_2a.png}}
\subfloat[]{\includegraphics[height=0.55\textwidth]{\fdir/080314_2b.png}}}
...
\subsection{Stop 2 -- Green point, Washington Park, 3:55 pm}
The name of this stop comes from the exposures of serpentinite, a metamorphosed mantle rock, found along a picturesque rocky shore in Washington park. It represents an upper-mantle section in the basal portion of the Fidalgo ophiolite. The rocks that we examined on the northern side of the beach at Green point had rusty-brown color characteristic of weathered mantle rocks in many ophiolite outcrops. We observed dunites and pyroxenites intersected by an extensive network of carbonate veins (Figure~\ref{fig:080314_2}). The ophiolite rocks at this location are overlain by loose glacial deposits.

\subsection{Stop 3 -- Mount Erie viewpoint, Mount Erie Park, 4:45 pm}
The rocks found on Mt. Erie represent the crustal section of the Fidalgo ophiolite that lie sequentially above the mantle serpentinite at stop 2. Here they consist mainly of diorite, a slightly more felsic rock than gabbro commonly found in ophiolite’s crustal section. They are interpreted to represent magmas formed below a chain of subduction-zone volcanoes. U-Pb zircon ages are 167 $\pm$ 5 Ma ~\citep{Tucker2014}. Thus, the Fidalgo ophiolite is interpreted to represent the lithosphere of a Jurassic volcanic arc. The whole sequence was tipped on its side during accretion, so the deepest portion, the serpentinite, is now found to the west (Washington Park), the uppermost portion, i.e. the ocean floor lavas and sedimentary rocks, are found toward the east, and the intracrustal intrusives are in the middle (Mt. Erie). The stop also offers spectacular views from small platforms on the summit knobs (Figure~\ref{fig:080314_3}). 
...
% Day 2 - August 4, 2014
\clearpage
\section{Day 2 -- August 4, 2014 \\  Fidalgo Ophiolite and drive to Baker}

\begin{tabbing}
\textbf{9:00 am:}	\hspace{0.3cm} \=Review before leaving campsite
...
\\\textbf{5:45 pm:}	\>Arrive at campsite
\end{tabbing}

In preparation for what we would see today, we reviewed the `classic' structure of oceanic crust that is expected within an ophiolite sequence, although in practice it is rarely all observed (Figure~\ref{fig:ophiolite}). We re-familiarised ourselves with the classification of ultramafic rocks, several of which we will see today (Figure~\ref{fig:ultramafic}) as well as with the classification of plutonic igneous rocks that we will see over the course of the field trip (Figure~\ref{fig:cumulate}). Note the important evolutionary sequence from gabbro/diorite, through tonalite, to granodiorite, and finally granite.

\begin{figure}[h]
\centering
\includegraphics[trim=2.8cm 5.5cm 2.5cm 3.2cm,clip=true,height=0.5\textheight]{\fdir/ophiolite_edited}
\label{fig:ophiolite}
...
\noindent \textit{Initial observations:}\\
...
\begin{tabbing}
\\\textbf{8:40 am:} \hspace{0.5cm} \= Depart campsite
\\\textbf{9:05 am:} 		\> Stop 1 -- Ice contact lava columns
\\\textbf{10:30 am:}	  	\> Stop 2 -- Parking lot at Sunrise
\\\textbf{11:00 am:}		\> Starting hiking 
\\\textbf{11:30 am:} 		\> Stop 3 --  Little ice age moraine of Emmons glaciers 
\\\textbf{12:30 pm:} 		\> Stop 4 --  On top of 2nd Burroughs Mtn.
\\\textbf{1:00 pm:} 		\> Lunch 
\\\textbf{1:30 pm:}		\> Stop 5 -- Pumice of the C tephra
\\\textbf{1:50 pm:}		\> Stop 6 --  Igneous inclusion in andesite
\\\textbf{2:15 pm:}		\> Stop 7 --  Back into granodiorite basement
\\\textbf{3:30 pm:}		\> Stop 8 -- Old mine at Glacial Basin
\\\textbf{4:30 pm:}		\> Hike out to White River exit and return to campsite
\\\textbf{5:30 pm:} 		\> Return to campground
\end{tabbing}

\noindent This day was dedicated to a 6 hour hiking on to the Burroughs Mountain at the northeastern side of Mt. Rainier National Park (Figure~\ref{fig:080814_9}). Total hiking distance was about 9 mi. The trail starts with a elevation climb from 6400 ft at Sunrise to 7400 ft at top of 2nd Burroughs Mtn (3.2 mi), followed by a descent to 4232 ft at White River Campground(6 mi).  We were joined by USGS scientist Tom Sisson, who gave a very thorough and informative introduction to volcanism at Mt. Rainier.  
\\
\\
\textbf{8:40 am} -- We left campsite, drove to White River Campground (the end of the trail, elevation 4232 ft). We parked one car here in order to shuttle drivers to the upper parking lot at Sunrise after the hike. 

\subsection[Stop 1 -- Roadside lava flow on Sunrise Park Road, 9:30 am]{Stop 1 -- Roadside of Sunrise Park Rd between White River Campground and Sunrise, 9:30 am}
On the downhill side of the road we saw andesitic lava flows from the modern Mt. Rainier ($<$500 ka). Tom pointed out that large volume lava flows are mostly found on ridge crests instead of valley floors. This is intriguing because one might think that lava flows would tend to flow down and fill valley floors first. One explanation was that the valley-filling lava had been eroded away. But given the young age ($\sim$40 ka) of these lavas, there is not enough time to erode away hundreds of meters of rocks. So this model was rejected.
\\\\
These ridge-forming lava flows have narrow, glassy columns pointing perpendicular to the ridge slope (Figure~\ref{fig:080814_1}). These are actually cooling features resulting from lava being chilled against glacier ice. The direction of columns corresponds to direction of maximum cooling - i.e. columns are parallel to thermal gradients -  indicating that lava was cooled from below.  In the valleys where ice was thick, lava flows were cooled rapidly, preventing it from flowing downhill. On the ridges where ice was thin, lava can melt away the ice and advance further. After the glacier retreated, the lava flows are left on the ridge.  These ice contact features are ubiquitous and one rarely sees valley floor lava. This feature suggests that these valleys were covered with thick ice during nearly all of Pleistocene. Furthermore, the top of these lava flows can be used to infer ice thickness at the time of the eruption.
...
\noindent We also saw some plutonic inclusions within the andesitic lava. These are porous, and are compositionally more mafic than the lava (according to Tom). These inclusions have been dated to be around the same age of the erupted lava. This suggests that these are genetically related to the lava (although slightly older), possibly included during some magma mingling activity. 

\subsection{Stop 2 -- Parking lot at Sunrise (elevation 6400 ft), 10:30 am}
As we are getting ready for the long hike, Tom gave us an intro of what we expect to see on this side of Mt Rainier (Figure~\ref{fig:080814_2}).  There are two summit craters at Rainier: \textit{East crater} which is taller and younger (shown in the picture) and \textit{West crater}. Both craters have steam vents with temperature measured to be up to 100$^{\circ}$C.  There is reportedly a subglacial crater lake inside the East crater, but only intrepid climbers have the chance to see this in person. This vantage point affords good views of Emmons glacier to the left (east) and Winthrop glacier to the right (north). In the intermediate foreground is the Steamboat Prow, which consists of a coarse fragmental deposit. \\
...
\noindent \textbf{11:00 am} -- We started hiking from the Sunrise parking lot towards Burroughs Mountain, which erupted sometime within the period 480-490 ka. This is the earliest large volume lava flow from the onset of the modern Mt. Rainier edifice.

\subsection{Stop 3 -- Little ice age moraine of Emmons glacier, 11:30 am}
As we hiked up the mountain, we got a better view of the Emmons glacier valley. To the north side of the valley (right side in the picture) we saw a sharp scarp along the valley. Outside the scarp there is developed forest, but inside the scarp there are no trees on the slope and very small trees in the valley. This turns out to be the limit of the glaciers during the little ice age; at the peak of little ice age the valley up to the tree line was covered by much larger glaciers than we observe today.  Coring of trees dates the cessation of the little ice age to be approximately the year 1850. 
Mike also pointed out the terminus of the Emmons glacier (Figure~\ref{fig:080814_3}). It is at the base of a dirty, seemingly rocky slope where a stream flows out. The lower reaches of the glacier are darker and appear rocky from a distance due to cover by landslide debris.
...
\subsection{Stop 4 -- Peak of 2nd Burroughs (elevation 7400 ft), 12:30 pm}
After we hiked to the top of the 2nd Burroughs Mountain, we took a closer look at Steamboat Prow. Steamboat Prow consists of coarse fragmented deposit that stratigraphically underlies the Burrows Mountain lava flow. The fragmental deposit dips away from the present summit by as much as 20 degrees, which suggests that a high edifice existed early in the growth of modern Rainier. This means that modern Rainier either was built on a tall ancestral Rainier or grew very fast. \\\\
Paleomagnetic measurements on the deposited clasts show that those near the top of Steamboat Prow have uniform magnetic orientations (that they are deposited hot), and those at lower elevation have random magnetic orientations (that they are deposited cold, or at least below the Curie temperature). The explanation is that the initially hot pyroclastic flow entrained glacial deposit on the way down, which lowered its temperature and transformed it into a lahar.
\\\\
\textbf{1:00 -- 1:20 pm} -- 	Lunch. 

\subsection{Stop 5 -- Pumice of the C tephra, 1:30 pm}

After deciding that we were not going to climb up to the 3rd Burroughs Mountain, we began descending down to the Glacial Basin Trail.  Near the beginning of the descend we stopped to look at the pumice from the C tephra deposit. This is from a 2200 year-old eruption, the most voluminous of the Holocene ($\sim$0.1 km$^3$). This is a compositionally diverse eruption. Most of the deposit is brown-ish andesite, but there are light color dacite streaks that may be attributable to magma mingling (Figure~\ref{fig:080814_5}), as well as pods of grey-ish vesicular andesite. Geochemical analysis showed that both are very high in Sr, similar to the Sr concentration of a 2500 year-old eruption.  The interpretation is that these dacite streaks and vesicular andesite are residues left over in the shallow magmatic system following the 2500 year-old eruption that were then mixed with the 2200 year-old magma and flushed out of the system.

\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{\fdir/080814_5.png}
\caption{Vesicular andesite (left) and regular andesite with white dacite blebs (right) within C tephra deposit.}
\label{fig:080814_5}
\end{figure}

\subsection{Stop 6 -- Igneous inclusion in andesite, 1:50 pm}
As we continued down the trail, near the base of the lava flow, we saw again some fine grain andesitic enclaves that are reportedly geochemically more evolved than the surrounding andesite (Figure~\ref{fig:080814_6}). They are interpreted to result from magma mingling activity. 
...
We continued hiking downhill. Shortly after the last stop (about 100 m elevation drop) we crossed a distinct lithological boundary between the younger andesitic lava and older crystalline granodiorite basement. 
\\\\
\textbf{3:00 pm} -- We came down the Burroughs Mountain Trail to the junction with the Glacial Basin Trail. The team split into two groups. One continued on to the Glacier Basin Camp (1.5 mi round trip), the other headed back directly to the White River Campground parking lot.

\subsection{Stop 8 -- Old mine at Glacier Basin, 3:30 pm}
The upper group enjoyed a romping hike up the Glacier Basin Trial. At the end of the trail we took in an excellent view of the Emmons Glacier (Figure~\ref{fig:080814_8}). An old mine used to operate here, drilling into the basement granodiorite for useful minerals (e.g. sulphite). We also saw some vertical radial dikes in the lava flow.
...
\\\\
\noindent \textbf{5:30 pm} -- Returned to campsite

\begin{figure}[h]
\centering
\includegraphics[width=1\textwidth]{\fdir/080814_9.png} 
...
% Day 7 - August 9, 2014
\clearpage
\section{Day 7 -- August 9, 2014: \\Hiking south side of Mt. Rainier}
\begin{tabbing}
\textbf{7:45 am:}  \hspace{0.4cm}\= Depart campsite\\
\textbf{8:53 am:}	\>Arrive at Paradise visitor center\\
\textbf{10:20 am:}	\>Began hike towards Panorama Point\\
\textbf{11:30 am:} 	\>Stop 1 -- Panorama of Cascade Range\\
\textbf{12:30 pm:}     \>Lunch at  Panorama Point\\
\textbf{2:00 pm:}     \>Stop 2 -- Glacier Vista\\
\textbf{2:30 pm:}     \>Moraine Trail\\
\textbf{4:00 pm:}     \>Drive to the next campsite\\
\textbf{6:00 pm:}     \>Arrival at Iron Creek Campground\\
\end{tabbing}

\subsection{Departure, 7:45 am}
We left camp without breakfast to beat the Saturday crowds. On the drive around to the south of Ranier we saw plutons from the Tatoosh Range (14 ma) to our south. \\

\noindent \textbf{8:53 am} -- Arrived at Paradise visitor's center to find that the parking lot was already very full, vindicating our early rise. We purchased breakfast at the Paradise Inn (Fig. \ref{fig:MW_daily_fig01}) and prepared lunches for the hike.\\

\begin{figure}[h]
\centering
\includegraphics[width=0.7\textwidth]{\fdir/MW_daily_fig01.jpg}
\caption{Mount Rainier visible behind Paradise Inn (or nearby building).}
\label{fig:MW_daily_fig01}
\end{figure}

\noindent \textbf{10:20 am} -- Began hike on trail towards Panorama Point.  Early stages of the trail are paved and crowded. Today we are on the south side of the mountain, yesterday we were on the northeast side.  There are more (and larger) glaciers on the north side of the mountain because it faces away from the sun. After Panorama Point trail, we plan on taking the Glacier Trail. Lenses visible in andesite along trail (Fig. \ref{fig:MW_daily_fig02}).  Lenses are lighter colored and contain plagioclase phenocrysts.  Flow banding is visible.

\begin{figure}[h]
\centering
\includegraphics[trim=10cm 0cm 0cm 10cm, clip=true,width=0.6\textwidth]{\fdir/MW_daily_fig02.jpg}
\caption{Lenses visible in andesite alongside the Panorama Point trail.  Lens cap and finger for scale.}
\label{fig:MW_daily_fig02}
\end{figure}
\begin{figure}[h]
\centering
\includegraphics[trim=0cm 0cm 0cm 15cm, clip=true,width=0.70\textwidth]{\fdir/MW_daily_fig03.jpg}
\caption{Mount St. Helens visible in the distance from Mount Rainier.  Eruption amphitheater is facing us. }
\label{fig:MW_daily_fig03}
\end{figure}
\FloatBarrier

\subsection{Stop 1 -- Panorama of Cascade Range, 11:30 am}
St. Helens visible in the distance to the south (Fig. \ref{fig:MW_daily_fig03}). We can see the north face of it, including the amphitheater and new dome.  Mt Adams is also visible in the distance - Mt Adams is surrounded by a large apron of volcanoclastic material, which is why it is volumetrically larger despite being less tall.  Its eruptions have been more explosive than Rainier. We discussed why it is difficult to come up with a universal theory of eruption styles.  The processes, involving multi-phase flow and different timescales are too complex. 

\subsection{Lunch at Panorama Point, 12:30 pm}
This lunch spot had excellent views, fully justifying the last stretch of more arduous hiking (Fig. \ref{fig:MW_daily_fig04}). Pyroclastics visible on trail up to Glacier Vista, in between what look like andesite flows. Andesite breaks in slaty pieces because of conjugate fracture pattern. \\

\begin{figure}[h]
\centering
\includegraphics[trim=10cm 0cm 0cm 0cm, clip=true,width=0.75\textwidth]{\fdir/MW_daily_fig04.jpg}
\caption{The group having lunch at Panorama Point.}
\label{fig:MW_daily_fig04}
\end{figure}

The group split up after lunch.  The self-styled ``exploration group'' (Jonathan, Zach, Jingle, Yang, and Mike) climbed two more minor peaks and met up with the main group again at Glacier Vista. 

\subsection{Stop 2 -- Glacier Vista, 2:00pm}
At Glacier Vista, Nisqually Glacier is visible in the valley (Fig \ref{fig:MW_daily_fig05}). The Little Ice Age scarp and lateral moraine are visible on opposite valley wall, while the glacier toe is covered in debris. The contact is visible in rocks exposed below the LIA scarp on the opposite valley wall.  It is difficult to distinguish coherent landslide blocks from exposed basement (Fig \ref{fig:MW_daily_fig06}). A waterfall emerging from beneath a small hanging glacier higher on the mountain can be observed entering the subglacial hydrology system beneath Nisqually Glacier (Fig \ref{fig:MW_daily_fig07}).

\begin{figure}[h]
\centering
\makebox[\textwidth]{
\subfloat[]{\includegraphics[width=0.5\textwidth]{\fdir/MW_daily_fig05.jpg} \label{fig:MW_daily_fig05}}
\subfloat[]{\includegraphics[width=0.5\textwidth]{\fdir/MW_daily_fig06.jpg} \label{fig:MW_daily_fig06}}}
\caption{\small{(a) Nisqually Glacier and surroundings visible from Glacier Vista.  The rocky valley floor visible in the mid-ground is actually the debris-covered tongue of the glacier.  The glacier toe is just visible at the left of the image.  Little Ice Age lateral moraine forms the far wall of the valley in the left side of the image. (b) Contact visible in the exposed valley wall above Nisqually Glacier.  Triangle of material in the middle of the picture of unknown origin. }}
\end{figure}

The deformation structures in the glacier reflect the overall strain rate regime that is expected for a mountain glacier.  Above the equilibrium line altitude (ELA), in the accumulation zone, the glacier experiences extension and thinning to compensate for a positive surface mass balance.  Subsidence caused by extension is (roughly) in balance with snowfall on the surface.  Ice flux increases from the mountain peak towards the ELA, reflecting the increasing volume of snowfall that must be removed by ice flow.  The extension is manifested in brittle failure features visible at the glacier surface, including crevasses and scarps (Figs \ref{fig:MW_daily_fig08} and \ref{fig:MW_daily_fig09}).  Crevasses are tensile cracks that form when the ice experiences extension or shear (shear stress can be decomposed into compression and tension along the principal axes).  Once they are formed, crevasses are simultaneously advected downstream and deformed by ice flow, resulting in a highly complex pattern of multiple crevasse orientations overprinted on each other in the main glacier trunk (Fig \ref{fig:MW_daily_fig10}).  In addition, crevasses also form to accommodate strain induced by local disturbances in the ice flow, such as turns in the glacier direction and resistant bedrock outcrops below the glacier.  In places, debris-covered portions of the glacier can be distinguished from the surrounding mountainside because crevasses in the underlying ice pull the debris apart (Fig \ref{fig:MW_daily_fig11}).  

\begin{figure}[ht]
\centering
\makebox[\textwidth]{
\subfloat[]{\includegraphics[width=0.5\textwidth]{\fdir/MW_daily_fig07.jpg} \label{fig:MW_daily_fig07}}
\subfloat[]{\includegraphics[width=0.5\textwidth]{\fdir/MW_daily_fig08.jpg} \label{fig:MW_daily_fig08}}}
\makebox[\textwidth]{
\subfloat[]{\includegraphics[width=0.5\textwidth]{\fdir/MW_daily_fig09.jpg} \label{fig:MW_daily_fig09}}
\subfloat[]{\includegraphics[width=0.5\textwidth]{\fdir/MW_daily_fig10.jpg} \label{fig:MW_daily_fig10}}}
\caption{\small{(a) Waterfall fed by subglacial hydrology in unknown upper glacier re-enters the subglacial hydrology of Nisqually Glacier. (b) Crevasses opening across a glacier near the summit of Mount Rainier, reflecting extension in the accumulation zone. (c) Crevasses opening into scarps on Nisqually Glacier.  Note exposed blue ice, indicating exposure of glacial ice from below the snow pack (white).  Also note that the heavy sediment load of the glacial ice appears to be concentrated in discrete fracture zones. (d) Complex deformation field visible near the confluence of Nisqually Glacier with one of its tributaries.}}
\end{figure}
\FloatBarrier

Below the ELA, in the ablation zone, the ice experiences compression and thickening to compensate for a negative surface mass balance.  Uplift caused by compression is (roughly) in balance with melting at the surface.  Ice flux decreases from the ELA to the glacier toe, reflecting the increasing volume of ice that has been lost to melting.  Crevasses are less common downstream, reflecting the compressional regime that tends to close them.  Some glaciers have thrust faults in the ablation zone, but these are hard to see from a distance on a debris-covered glacier (they are identified by dipping, arcuate bands of sediment outcropping at the glacier surface) and we don't know if Nisqually has them.  The debris cover on the glacier surface becomes thicker downstream, reflecting the selective removal of ice (but not sediment) by melting.  Thick debris can act to insulate the glacier surface and reduce melting, counteracting the albedo effect seen with thin debris cover.

\begin{figure}[h]
\centering
\makebox[\textwidth]{
\subfloat[]{\includegraphics[width=0.5\textwidth]{\fdir/MW_daily_fig11.jpg} \label{fig:MW_daily_fig11}}
\subfloat[]{\includegraphics[width=0.5\textwidth]{\fdir/MW_daily_fig12.jpg} \label{fig:MW_daily_fig12}}}
\caption{\small{(a) Crevasses in a debris-covered part of Nisqually Glacier. Note the sediment is pulled apart by cracks in the underlying ice. (b) The outlet of the subglacial hydrological system at the toe of Nisqually Glacier, viewed from the LIA lateral moraine.}}
\end{figure}

Like most mountain glaciers in the summer, this glacier toe hosts an outlet of the subglacial hydrological system.  This outlet is a large (several meters) tunnel from which a proglacial stream emerges (Fig 12).  The fact that meltwater is released from a single coherent point, rather than diffusely across the entire toe, reflects a highly organized and efficient subglacial hydrological network.  Underneath the glacier, small pipes feed into large pipes in a dendritic system similar to subaerial rivers and tributaries.  These pipes can be carved into the bedrock, melted out of the overlying ice, or both (the outlet visible at the toe of this glacier appeared to be carved upwards into the ice, although we only saw it from a distance).  These pipes carry a large volume of water without lubricating much of the basal area.  Efficient subglacial hydrological networks are a common feature of glaciers that have to move large quantities of meltwater in the summer.  Generally these systems take several weeks to develop; in the interim, glaciers often experience a spring speed-up when water spreads out over the bed before the hydrological system has developed the capacity to move the water efficiently.  Once the efficient system develops, large amounts of water may be in motion below the glacier, but the pipes that carry this water occupy only a small fraction of the basal area, reducing lubrication.  However, sudden spikes in water input (such as from rainstorms) can temporarily overwhelm the system and cause water to spread out on the bed.  

\subsection{Moraine Trail, 2:30 pm}
We took the Moraine Trail, an unmaintained path going out to the crest of one of the LIA lateral moraines of Nisqually Glacier and then back in a loop.  Trail was easy to follow, despite being unmaintained.  The return part of the loop included a steep ascent that would have been dangerous going downhill.  Take a right at the fork to make sure you take the steep slope going uphill, which is safer.  Trail runs along the top of the LIA lateral moraine (Fig \ref{fig:MW_daily_fig13}).

Up close we can see that the glacier tongue splits in two, with exposed bedrock in the middle - possibly plutonic Tatoosh. The ice surface is extremely dirty, and in places can be hard to distinguish from un-vegetated valley floor/walls.  However, the ice surface (where it is exposed) appears darker than the rock and the glacier toe has multiple holes representing abandoned outlets of the subglacial hydrological system (Fig \ref{fig:MW_daily_fig14}). Both branches of the glacier tongue have water outlets.  The larger branch has the hydrologic outlet roughly in the middle, the smaller branch has an outlet near the contact with the lateral moraine.

\begin{figure}[h]
\centering
\makebox[\textwidth]{
\subfloat[]{\includegraphics[width=0.5\textwidth]{\fdir/MW_daily_fig13.jpg} \label{fig:MW_daily_fig13}}
\subfloat[]{\includegraphics[width=0.5\textwidth]{\fdir/MW_daily_fig14.jpg} \label{fig:MW_daily_fig14}}}
\caption{\small{(a) The group hiking on the Moraine Trail.  This portion of the trail runs along the crest of the LIA lateral moraine. (b)  Abandoned outlet of the subglacial hydrological system beneath Nisqually Glacier.  Dark material above the opening is debris-covered ice, material below the opening is ice-free till.}}
\end{figure}

Nisqually Glacier is relatively well-studied.  The terminus position has been monitored since the 1940's because of water resource concerns in the downstream river valley.  It advanced between the 1940's and the 1970's, then began a retreat that continues today.  Currently the terminus is in a position similar to where it was in the 1940's.  Retreat can also be inferred between the LIA moraines, deposited in the mid-1800's, and the 1940's, although monitoring was not taking place then.  

\subsection{Drive to the next campsite, 16:00 pm}
Our drive out of ranger took us back east, past the Reflection Lakes and Box Canyon, which comprises a fracture system in the Tatoosh that is easily erodible. It has been occupied by both rivers and glaciers. We observed a welded tuff, with its disctinctive stretched out clasts, as well as with andesite dikes and observable columnar joints. The Rainier edifice is built on Tatoosh granodiorite, a Miocene age quartz monzanite.

On the way south, towards Mt St. Helens and the Iron Creek campsite that was to be our next overnight location, we passed the Ohanapecosh formation along Rte 123. This is an Oligocene (27-37 Ma) intrusive andesites conatining columnar joints. We passed Packwood lake on Rte 12, a landslide-dammed lake (with a small creek for drainage, so it is no longer filling).

As the road bends due west towards Randall, we found ourselves driving through a flat valley, with flood deposits exposed in river bank.  These flooding episodes have good age constraints because of tephra layers. The fertile soil supports extensive farming, which is presumably why people brave the multiple natural hazards. We passed through the town of Randall, which was the base of northern operations for the IMUSH seismic deployment (which Zach participated in).  A fond tribute was paid to the uneven pool tables in the Tall Timber Bar. We turned south down into the Gifford Pinchot National Forest, towards Mt. St. Helens. \\

\noindent\textbf{6:00 pm} -- Arrival at Iron Creek Campground. 
...
\begin{tabbing}
\textbf{9:00 am:}  \hspace{0.5cm} \= Depart Iron Creek Campground, head towards Windy Ridge\\
...
\textbf{13:27 pm:} 	\>Stop 5 -- Arrive at Truman Trailhead and begin hike into the Pumice Plain\\
\textbf{15:55 pm:} 	\>Return to Windy Ridge parking lot and depart for Iron Creek\\
\textbf{16:15 pm:} 	\>Stop 6 -- Mine Car\\
\textbf{17:30 pm:}  	\>Arrive at Iron Creek Campsite
\end{tabbing}

\subsection{Stop 1 -- Bear Meadow, 9:50 am}

Here, Gary Rosenquist and his friends captured 22 pictures of the landslide and the following lateral blast at Mt. St. Helens on May 17, 1980 (Figure~\ref{fig: 081014_1}). Activity prior to the eruption started as early as March 1980. As concern mounted scientists started to closely monitor the volcano. In these two months, the north side of the volcano rapidly expanded, with surface deformation reaching a rate of about 1 m/day just before the eruption. A spike in small magnitude earthquakes was also observed. Restricted areas were established around the volcano, however these were based on the assumption that the volcano would erupt vertically. The eruption started with an magnitude 5 earthquake which triggered a landslide. The mass movement of the landslide decompressed the magmatic system, which led to a lateral blast from the side where the landslide occurred. Following the eruption, the group struggled to escape the area by driving east. The ash blocked the sunlight and rained on their windshield. It took them hours to drive out and luckily their engine was not choked by the ash.
