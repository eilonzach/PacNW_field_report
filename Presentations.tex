...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.70\textwidth, angle=0]{PaperFigs/Raj_region.png}
\end{center}
...
\begin{subfigure}{.45\textwidth}
	\centering
	\includegraphics[width=\linewidth]{PaperFigs/Raj_div1.png}
	 \caption{First-order subdivision of the Cordilleran orogen.}
	\label{fig:division1}
\end{subfigure}	
\begin{subfigure}{.45\textwidth}
	\centering
	\includegraphics[width=\linewidth]{PaperFigs/Raj_div2.png}
...
\begin{subfigure}{.45\textwidth}
	\centering
	\includegraphics[width=\linewidth]{PaperFigs/Raj_plate1.jpg}
	 \caption{Early Devonian (400 Ma)}
	\label{fig:NAM1}
\end{subfigure}	
\begin{subfigure}{.45\textwidth}
	\centering
	\includegraphics[width=\linewidth]{PaperFigs/Raj_plate2.jpg}
...
\begin{subfigure}{.35\textwidth}
	\centering
	\includegraphics[width=\linewidth]{PaperFigs/Raj_50Ma.png}
	 \caption{Global subduction configuration.}
	\label{fig:plate1}
\end{subfigure}	
\begin{subfigure}{.60\textwidth}
	\centering
	\includegraphics[width=\linewidth]{PaperFigs/Raj_50Ma2.png}
...
\begin{subfigure}{.45\textwidth}
	\centering
	\includegraphics[width=\linewidth]{PaperFigs/Raj_siletzia1.png}
	 \caption{Formations composing Siletzia (red) and postaccretion basaltic magmatism (blue).}
	\label{fig:siletzia1}
\end{subfigure}	
\begin{subfigure}{.45\textwidth}
	\centering
	\includegraphics[width=\linewidth]{PaperFigs/Raj_siletzia2.png}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.50\textwidth, angle=0]{PaperFigs/Raj_paleo.png}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.50\textwidth, angle=0]{PaperFigs/Raj_vel.png}
\end{center}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=0.68\textwidth,trim=100 45 125 60, clip, angle=0]{PaperFigs/Casc_active.pdf}
\end{center}
...
As seen in figure \ref{fig:active}, Cascadia has been quite extensively studied using active-source seismic methods. \citet{Parsons1998} (Figure \ref{fig:parsons}) and \citet{Gerdom2000} used wide angle onshore and offshore data to image the subducting Juan de Fuca crust from the margin region offshore to just as it begins to descend beneath the North American plate. In addition to providing velocity profiles of the North American plate and the subducting crust, they have observed a region of high reflectivity along the  subducting plate interface that may indicate hydration within the subducting crust and have implications for the locked zone of the plate interface. Since the link between megathrust fault slip and hydration is not fully understood, it is important to be able to estimate the water that may be contained within the slab. One proxy for this is using the extent of faulting within the slab, in particular faults that reach the mantle that may cause serpentinization which can be determined using MCS data \citep{Nedimovic2009} (Figure \ref{fig:mcs}).\\
 ...
 \begin{figure}[h]
\begin{center}
\includegraphics[width=0.98\textwidth,trim=0 270 0 270, clip, angle=0]{PaperFigs/Parsons_1998}
\end{center}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=0.27\textwidth,trim=100 10 100 0, clip, angle=0]{PaperFigs/Nedimovic2009_2.pdf}
\end{center}
...
\end{figure}
 ...
 \begin{figure}[h]
\begin{center}
\includegraphics[width=0.68\textwidth,trim=100 45 125 60, clip, angle=0]{PaperFigs/Casc_passive.pdf}
\end{center}
...
\begin{figure}[h]
  \begin{minipage}[b]{0.5\linewidth}
    \centering
    \includegraphics[scale=.4,trim=0 170 0 170, clip=true]{PaperFigs/abers_map.pdf}
  ...
  \begin{minipage}[b]{0.5\linewidth}
    \centering
    \includegraphics[scale=.4,trim=0 100 0 100, clip=true]{PaperFigs/abers_RF.pdf}
...
\begin{figure}
  \begin{center}
  \includegraphics[trim=0cm 1cm 0cm 3cm,clip=true,width=0.7\textwidth]{PaperFigs/cascadia_eq_sources}
...
\begin{figure}
  \begin{center}
  \includegraphics[trim=1cm 1.5cm 1cm 9.2cm,clip=true,width=0.7\textwidth]{PaperFigs/IRIS_stamap}
  \label{figs:IRIS_stamap}
  \includegraphics[trim=3cm 18.72cm 12cm 4.6cm,clip=true,width=0.2\textwidth]{PaperFigs/IRIS_stamap_legend}
...
\begin{figure}
    \centering
    \null\hfill
    \subfloat[\small{Seismicity in Cascadia since 1971: $\sim$1500 earthquakes total}]{\makebox[1.2\width]{\includegraphics[height=0.6\textwidth]{PaperFigs/cascadia_seismicity}}}
    \hfill
    \subfloat[\small{Seismicity at Japan trench since 1971: 5000 shown, of $\sim$50000 earthquakes total}]{\includegraphics[height=0.6\textwidth]{PaperFigs/japan_seismicity}}
    \hfill\null
    \caption{\small{Comparison of seismicity at Cascadia and NE Japan, at the same scale. Only M$\ge$3 are shown.}}
...
\begin{figure}[h]
  \begin{center}
  \includegraphics[width=\textwidth]{PaperFigs/satake2003}
...
\begin{figure}[h]
  \begin{center}
    \includegraphics[trim=0cm 4.3cm 0cm 0cm,clip=true,width=0.45\textwidth]{PaperFigs/seismic_cycle_cartoon}
...
\begin{figure}[h]
    \includegraphics[trim=0cm 0cm 0cm 0cm,clip=true,width=0.8\textwidth]{PaperFigs/seismic_cycle_eg}
...
\begin{figure}[h]
    \includegraphics[width=0.6\textwidth]{PaperFigs/Nedimovic_JdF}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.55\textwidth]{PaperFigs/Bostock2002}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{PaperFigs/Evans2013}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=\textwidth]{PaperFigs/Nedimovic2003}
...
\begin{figure}[1,h!]
  \centering
  \includegraphics[width=0.75\textwidth]{PaperFigs/imush_passive}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\textwidth]{PaperFigs/imush_active_receivers}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.5\textwidth]{PaperFigs/Scholz_BDT}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.5\textwidth]{PaperFigs/GPS_seismicity}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.5\textwidth]{PaperFigs/ETS_migration}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.5\textwidth]{PaperFigs/ETS_water}
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=6in]{PaperFigs/vel_map}
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=6in]{PaperFigs/gmt}
...
\begin{figure}
   \begin{center}
    \includegraphics[width=0.4\textwidth]{PaperFigs/Yang_1a}
    \hfill
    \includegraphics[width=0.5\textwidth]{PaperFigs/Yang_1b}
    \hfill\null
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=6in]{PaperFigs/Yang_2}
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=6in]{PaperFigs/Yang_3}
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=6in]{PaperFigs/Yang_4}
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=0.75\textwidth]{PaperFigs/MtRainierHazards}
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=0.5\textwidth]{PaperFigs/MtRainierLahars}
...
\begin{figure}
   \begin{center}
    \includegraphics[width=0.3\textwidth]{PaperFigs/MtRainierGlaciers1}
    \hfill
    \includegraphics[width=0.3\textwidth]{PaperFigs/MtRainierGlaciers2}
    \hfill
    \includegraphics[width=0.3\textwidth]{PaperFigs/MtRainierGlaciers3}
    \hfill\null
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=0.5\textwidth]{PaperFigs/Celia_1}
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=0.5\textwidth]{PaperFigs/Celia_2}
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=0.5\textwidth]{PaperFigs/Celia_3}
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=0.5\textwidth]{PaperFigs/Celia_4}
	\caption{Before and after the May 1980 eruption of St. Helens, looking from the North.}
	\label{Celia_4}
\end{figure}
\begin{figure}[htp]
	\centering
	\includegraphics[width=0.5\textwidth]{PaperFigs/Celia_5}
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=0.5\textwidth]{PaperFigs/Natalia_1}
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=0.5\textwidth]{PaperFigs/Natalia_2}
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=0.5\textwidth]{PaperFigs/Natalia_3}
...
\begin{figure}
   \begin{center}
    \includegraphics[width=0.2\textwidth]{PaperFigs/Natalia_4a}
    \quad
    \includegraphics[width=0.3\textwidth]{PaperFigs/Natalia_4b}
    \hfill\null
...
\begin{figure}
   \begin{center}
    \includegraphics[width=0.25\textwidth]{PaperFigs/Natalia_5c}
    \quad
    \includegraphics[width=0.25\textwidth]{PaperFigs/Natalia_5b}
    % leave this space blank so that the last picture will go on the next line
    \includegraphics[width=0.6\textwidth]{PaperFigs/Natalia_5a}
    \center
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=0.5\textwidth]{PaperFigs/Jonathan_1}
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=0.5\textwidth]{PaperFigs/Jonathan_2}
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=0.5\textwidth]{PaperFigs/Jonathan_3}
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=0.5\textwidth]{PaperFigs/Mike_1}
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=0.5\textwidth]{PaperFigs/Mike_2}
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=0.75\textwidth]{PaperFigs/Keren_1}
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=0.75\textwidth]{PaperFigs/Nandini_1}
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=0.75\textwidth]{PaperFigs/Nandini_2}
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=0.75\textwidth]{PaperFigs/Nandini_3}
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=0.75\textwidth]{PaperFigs/Nandini_4}
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=0.75\textwidth]{PaperFigs/Nandini_5}
